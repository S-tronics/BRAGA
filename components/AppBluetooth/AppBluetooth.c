...
#define TEST_DEVICE_NAME            "ATC_BRAGA_SERVER"
...
;---------------------------------------------------------------------------------------------------------------------*/
static const char *TAG = "BRAGA BluetoothComponent";
...
static uint8_t adv_service_uuid128[16] = {
    ...
    //0x02, 0x00, 0x12, 0xac, 0x42, 0x02, 0x61, 0xa2, 0xed, 0x11, 0x41, 0x3A, 0xf2, 0x59, 0x21, 0xe6,
};
...
static esp_ble_adv_data_t adv_data = {
    .set_scan_rsp = false,
    .include_name = true,
    .include_txpower = true,                        //Apple, accesorie has to send TX-power
    .min_interval = 0x000C, //slave connection min interval, Time = min_interval * 1.25 msec        //Apple recommends min. 15ms
    .max_interval = 0x0010, //slave connection max interval, Time = max_interval * 1.25 msec        //Apple recommends 20ms
    .appearance = 0x00,
    ...
    .flag = (ESP_BLE_ADV_FLAG_GEN_DISC | ESP_BLE_ADV_FLAG_BREDR_NOT_SPT),      //General Discovery mode; Basic Rate and Enhanced Data Rate not supported
};
...
static esp_ble_adv_params_t adv_params = {
    .adv_int_min        = 0x20,                     //N * 0.625ms = 20ms
    .adv_int_max        = 0x40,
    .adv_type           = ADV_TYPE_IND,             //General Indicator
    .own_addr_type      = BLE_ADDR_TYPE_PUBLIC,
    //.peer_addr            =
    //.peer_addr_type       =
    .channel_map        = ADV_CHNL_ALL,             //Channel 37, 38 en 39
...
void AppBluetooth_Init(void)
{
    ...
    */
    ...
    ESP_LOGI(TAG, "Init Bluetooth Done");
}
/*--------------------------------------------------------------------------------------------------------------------*/
